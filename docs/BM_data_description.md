...
#### OCNMFW2: Generating Plant Demand Margin, 2-52 weeks ahead
  Parameters:
    CY: Calendar year (int)
    WN: Week number (int)
    DM: Demand Margin (MW, float)
...
#### SYSMSG: System Message
  Parameters:
    MT: Message type, 6 char string
    SM: System warning message
...
#### DCONTROL: Demand Control Instruction Notification
  Parameters:
    DS: Affected LDSO (string)
    ID: Demand Control ID, unique identifier, integer
    SQ: Instruction Sequence No, integer
    EV: Demand Control Event Flag, 'I' indicates instruction by the SO or emergency manual disconnection. 'L' indicates automatic low frequency demand disconnection
    TF: Time From
    TI: Time To
    VO: Demand Control Level, MW
    SO: SO-Flag, 'T' indicates that an instruction should be considered to be potentially impacted by transmission constraints
    AM: Amendment Flag: 'ORI' : Original, 'INS' : Insert, 'UPD' : Update
...
#### TEMP: Temperature Data
  Parameters:
    TO: Outturn Temperature (celsius)
    TN: Normal Reference Temperature (celsius)
    TL: Low Reference Temperature (celsius)
    TH: High Reference Temperature (celsius)
