...
BSAD
  ...
  Parameters:
    ...
    A3: Sell price price adjustment in £/MWh
    A4: Buy price cost Adjustment
    A5: Buy price volume Adjustment
    A6: Buy price price adjustment in £/MWh
  Example entry:
...
EBSP
  ...
  Parameters:
    PB: The price that must be paid for electricity which is out of balance.
    PS: Sell Price - the price received for electricity which is out of balance.
    AO: Total Accepted Offer Volume - System wide total Accepted Offer Volume for the Settlement Period
    AB: Total Accepted Bid Volume - System wide total Accepted Bid Volume for the Settlement Period
    AP: Total Unpriced Accepted Offer Volume - System wide total Unpriced Accepted Offer Volume for the Settlement Period
    AC: Total Unpriced Accepted Bid Volume - System wide total Unpriced Accepted Bid Volume for the Settlement Period
    PP: Total Priced Accepted Offer Volume - System wide total Priced Accepted Offer Volume for the Settlement Period
    PC: Total Priced Accepted Bid Volume - System wide total Priced Accepted Bid Volume for the Settlement Period
    BD: BSAD Defaulted (boolean) - If True the following BSAD fields are default values
    A1: Sell price cost Adjustment
    A2: Sell price volume Adjustment
    A3: Sell price price adjustment in £/MWh
    A4: Buy price cost Adjustment
...
NETEBSP
  ...
  Parameters:
    PB: The price that must be paid for electricity which is out of balance.
    PS: Sell Price - the price received for electricity which is out of balance.
    PD: Price Derivation Code - A code that describes the way in which SSP and SBP were calculated
    AO: Total Accepted Offer Volume - System wide total Accepted Offer Volume for the Settlement Period
    AB: Total Accepted Bid Volume - System wide total Accepted Bid Volume for the Settlement Period
    AP: Total Unpriced Accepted Offer Volume - System wide total Unpriced Accepted Offer Volume for the Settlement Period
    AC: Total Unpriced Accepted Bid Volume - System wide total Unpriced Accepted Bid Volume for the Settlement Period
    ...
    A8: Net Energy Sell Price Volume Adjustment (MWh)
    A11: Net System Sell Price Volume Adjustment (MWh)
    A3: Sell Price Price Adjustment (£/MWh)
    A9: Net Energy Buy Price Cost Adjustment (£)
    A10: Net Energy Buy Price Volume Adjustment (MWh)
    A12: Net System Buy Price Volume Adjustment (MWh)
    A6: Buy Price Price Adjustment (£/MWh)
  Example entry:
...
MEL / MIL
  Maximum Export Limit / Minimum Import Limit
  Message consists of 2 timestamp and power value pairs, relating to elbow points
  Parameters:
    NP: Number of spot points, integer (expected=2)
    TS: Timestamp of point, formatted yyyy:MM:dd:hh:mm:ss:GMT
