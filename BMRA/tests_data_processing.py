...
class DataProcessingTestCase(unittest.TestCase):
    ...
    def test_test_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 8, 14, 11, 59, 48, tzinfo=timezone.utc),
                         'subject' : 'BMRA.INFO.TEST',
                         'message_type' : 'INFO',
    ...
    def test_msg_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 10, 8, 16, 11, 5, tzinfo=timezone.utc),
                         'subject' : 'BMRA.INFO.MSG',
                         'message_type' : 'INFO',
                         'message_subtype' : 'MSG',
    ...
    def test_msg_to_dict2(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2006, 5, 16, 7, 20, 1, tzinfo=timezone.utc),
                         'subject' : 'BMRA.INFO.MSG',
                         'message_type' : 'INFO',
                         'message_subtype' : 'MSG',
                         'TP' : dt.datetime(2006, 5, 16, 7, 20, tzinfo=timezone.utc),
    ...
    def test_data_subset_to_dict_single(self):
        ...
        SP=1,VD=23700.0'
        expected_dict = {1:
                         {'TP' : dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc),
    ...
    def test_data_subset_to_dict_double(self):
        ...
        expected_dict = {1:
                         {'TS' : dt.datetime(2017, 3, 29, 1, tzinfo=timezone.utc),
                          'VP' : 0.0},
                         2:
                         {'TS' : dt.datetime(2017, 3, 29, 1, 30, tzinfo=timezone.utc),
                          'VP' : 0.0}}
        self.assertEqual(message_part_to_points(input_str,
                                                2,
                                                'BM',
    ...
    def test_fpn_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 2, 3, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_ABTH9.FPN',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_ABTH9',
                         'message_subtype' : 'FPN',
    ...
    def test_qpn_to_dict(self):
        ...
        message={SD=2017:03:29:00:00:00:GMT,SP=5,NP=2,\
        TS=2017:03:29:01:00:00:GMT,VP=0.0,TS=2017:03:29:01:30:00:GMT,VP=0.0}'
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 2, 17, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.E_ABERDARE.QPN',
                         'message_type' : 'BM',
                         'bmu_id' : 'E_ABERDARE',
                         'message_subtype' : 'QPN',
                         'SD' : dt.date(2017, 3, 29),
    ...
    def test_mel_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 2, 16, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_SIZB2.MEL',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_SIZB2',
                         'message_subtype' : 'MEL',
                         'SD' : dt.date(2017, 3, 29),
    ...
    def test_mil_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 1, 51, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_DRAXX1.MIL',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_DRAXX1',
                         'message_subtype' : 'MIL',
                         'SD' : dt.date(2017, 3, 29),
    ...
    def test_bod_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 2, 2, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_DRAXX1.BOD.4',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_DRAXX1',
                         'message_subtype' : 'BOD',
                         'SD' : dt.date(2017, 3, 29),
    ...
    def test_ebocf_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 21, 54, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_EECL-1.EBOCF.1',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_EECL-1',
    ...
    def test_boav_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 21, 54, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_EECL-1.BOAV.1',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_EECL-1',
    ...
    def test_disptav_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 21, 54, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_EECL-1.DISPTAV.1',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_EECL-1',
    ...
    def test_ptav_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2009, 1, 1, 0, 20, 20, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_DAMC-1.PTAV.-1',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_DAMC-1',
                         'message_subtype' : 'PTAV',
                         'SD' : dt.date(2008, 12, 31),
                         'SP' : 48,
                         'NN' : -1,
                         'OV' : 1.5833334,
                         'BV' : -8.333333,
    ...
    def test_qas_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 7, 12, 49, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_BAGE-1.QAS',
                         'message_type' : 'BM',
                         'bmu_id' : 'T_BAGE-1',
                         'message_subtype' : 'QAS',
                         'SD' : dt.date(2017, 4, 20),
                         'SP' : 1,
                         'SV' : 1.621
                         }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_mid_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 0, 37, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.MID',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'MID',
                         'SD' : dt.date(2017, 3, 29),
                         'SP' : 2,
    ...
    def test_sel_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 1, 21, 21, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_ROCK-1.SEL',
    ...
    def test_sil_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 2, 11, 56, 15, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.2__MPGEN002.SIL',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'SIL',
                         'bmu_id' : '2__MPGEN002',
                         'TE' : dt.datetime(2018, 1, 2, 11, 54, tzinfo=timezone.utc),
                         'SI' : 0.0
                        }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_mnzt_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 1, 21, 54, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_STAY-2.MNZT',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'MNZT',
                         'bmu_id' : 'T_STAY-2',
                         'TE' : dt.datetime(2017, 4, 21, 1, 21, tzinfo=timezone.utc),
                         'MN' : 360
                        }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_ndz_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 1, 21, 55, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_STAY-2.NDZ',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'NDZ',
                         'bmu_id' : 'T_STAY-2',
                         'TE' : dt.datetime(2017, 4, 21, 1, 21, tzinfo=timezone.utc),
    ...
    def test_rure_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 1, 22, 19, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_STAY-2.RURE',
                         'message_type' : 'DYNAMIC',
    ...
    def test_ruri_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 1, 2, 17, 2, 1, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.2__JYELG001.RURI',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'RURI',
                         'bmu_id' : '2__JYELG001',
                         'TE' : dt.datetime(2002, 1, 2, 17, tzinfo=timezone.utc),
                         'U1' : 900.0,
                         'UB' : 0,
                         'U2' : 0.0,
                         'UC' : 0,
    ...
    def test_rdre_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 5, 4, 39, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_ROCK-1.RDRE',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'RDRE',
                         'bmu_id' : 'T_ROCK-1',
                         'TE' : dt.datetime(2017, 4, 21, 5, 4, tzinfo=timezone.utc),
                         'R1' : 25.0,
                         'RB' : 220,
                         'R2' : 47.5,
                         'RC' : 125,
    ...
    def test_rdri_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 1, 2, 17, 1, 50, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.2__JYELG001.RDRI',
                         'message_type' : 'DYNAMIC',
    ...
    def test_mdv_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 1, 2, 17, 1, 13, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.2__JYELG001.MDV',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'MDV',
                         'bmu_id' : '2__JYELG001',
                         'TE' : dt.datetime(2002, 1, 2, 17, tzinfo=timezone.utc),
    ...
    def test_mdp_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 1, 2, 17, 1, 14, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.2__JYELG001.MDP',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'MDP',
                         'bmu_id' : '2__JYELG001',
                         'TE' : dt.datetime(2002, 1, 2, 17, tzinfo=timezone.utc),
    ...
    def test_mzt_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 2, 20, 27, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_FOYE-2.MZT',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'MZT',
                         'bmu_id' : 'T_FOYE-2',
                         'TE' : dt.datetime(2017, 4, 21, 2, 19, tzinfo=timezone.utc),
                         'MZ' : 30
                        }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_ntb_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 2, 20, 44, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_FOYE-2.NTB',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'NTB',
                         'bmu_id' : 'T_FOYE-2',
                         'TE' : dt.datetime(2017, 4, 21, 2, 19, tzinfo=timezone.utc),
    ...
    def test_nto_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 2, 20, 44, tzinfo=timezone.utc),
                         'subject' : 'BMRA.DYNAMIC.T_FOYE-2.NTO',
                         'message_type' : 'DYNAMIC',
                         'message_subtype' : 'NTO',
                         'bmu_id' : 'T_FOYE-2',
                         'TE' : dt.datetime(2017, 4, 21, 2, 19, tzinfo=timezone.utc),
    ...
    def test_freq_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 0, 52, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.FREQ',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'FREQ',
                         'TS' : dt.datetime(2017, 3, 28, 23, 58, 0, tzinfo=timezone.utc),
                         'SF' : 50.058
                        }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_boalf_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 0, 43, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_SCCL1.BOALF',
                         'message_type' : 'BM',
                         ...
                         'SO' : True,
                         'PF' : False,
                         'TA' : dt.datetime(2017, 4, 20, 23, 59, 00, tzinfo=timezone.utc),
                         'AD' : False,
                         'data_points':
                         {1:
                          {'TS' : dt.datetime(2017, 4, 21, 0, 5, 0, tzinfo=timezone.utc),
                           'VA' : 367.0},
                          2:
                          {'TS' : dt.datetime(2017, 4, 21, 0, 9, 0, tzinfo=timezone.utc),
                           'VA' : 310.0},
                          3:
                          {'TS' : dt.datetime(2017, 4, 21, 0, 35, 0, tzinfo=timezone.utc),
                           'VA' : 310.0},
                          4:
                          {'TS' : dt.datetime(2017, 4, 21, 0, 39, 0, tzinfo=timezone.utc),
                           'VA' : 367.0}}}
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_boal_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2009, 1, 1, 0, 9, 41, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BM.T_SHBA-1.BOAL',
                         'message_type' : 'BM',
                         'message_subtype' : 'BOAL',
                         'bmu_id' : 'T_SHBA-1',
                         'NK' : 59073,
                         'TA' : dt.datetime(2009, 1, 1, 0, 9, tzinfo=timezone.utc),
                         'AD' : False,
                         'data_points':
                         {1:
                          {'TS' : dt.datetime(2009, 1, 1, 0, 11, 0, tzinfo=timezone.utc),
                           'VA' : 597.0},
                          2:
                          {'TS' : dt.datetime(2009, 1, 1, 0, 13, 0, tzinfo=timezone.utc),
                           'VA' : 560.0},
                          3:
                          {'TS' : dt.datetime(2009, 1, 1, 0, 28, 0, tzinfo=timezone.utc),
                           'VA' : 560.0},
                          4:
                          {'TS' : dt.datetime(2009, 1, 1, 0, 30, 0, tzinfo=timezone.utc),
                           'VA' : 498.0}}}
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_fuelhh_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 0, 58, tzinfo=timezone.utc),
    ...
    def test_disbsad_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 9, 12, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.DISBSAD',
                         'message_type' : 'SYSTEM',
    ...
    def test_bsad_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2003, 1, 1, 0, 8, 12, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.BSAD',
                         'message_type' : 'SYSTEM',
    ...
    def test_netbsad_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 9, 13, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.NETBSAD',
                         'message_type' : 'SYSTEM',
    ...
    def test_netebsp_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2009, 1, 1, 0, 20, 48, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.NETEBSP',
                         'message_type' : 'SYSTEM',
    ...
    def test_ebsp_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2003, 1, 1, 0, 20, 32, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.EBSP',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'EBSP',
                         'SD' : dt.date(2002, 12, 31),
                         'SP' : 48,
                         'PB' : 15.13,
                         'PS' : 11.10644,
                         'AO' : 307.2657,
    ...
    def test_soso_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 10, 51, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.SOSO',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'SOSO',
                         'TT' : 'EWIC_NG',
                         'ST' : dt.datetime(2017, 4, 21, 2, tzinfo=timezone.utc),
                         'TD' : 'A02',
    ...
    def test_fuelinst_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 1, 10, tzinfo=timezone.utc),
    ...
    def test_indo_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 1, 8, tzinfo=timezone.utc),
    ...
    def test_nonbm_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 1, 24, tzinfo=timezone.utc),
    ...
    def test_itsdo_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 3, 29, 0, 1, 9, tzinfo=timezone.utc),
    ...
    def test_dcontrol_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2015, 11, 30, 11, 35, 59, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.DCONTROL',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'DCONTROL',
                         'TP' : dt.datetime(2015, 11, 30, 11, 32, 32, tzinfo=timezone.utc),
                         'data_points' : {
                             1 : {
                                 'DS' : 'ETCL',
                                 'ID' : 2,
    ...
    def test_tsdf_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 16, 40, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.TSDF.B1',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'TSDF',
                         'ZI' : 'B1',
                         'data_points' : {1: {'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 1, 'VD': 218.0}, 2: {'TP': dt.datetime(2017, 4, 20, 23, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 2, 'VD': 211.0}, 3: {'TP': dt.datetime(2017, 4, 20, 23, 45, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 3, 'VD': 217.0}, 4: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 4, 'VD': 217.0}, 5: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 5, 'VD': 215.0}, 6: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 6, 'VD': 212.0}, 7: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 7, 'VD': 209.0}, 8: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 8, 'VD': 207.0}, 9: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 9, 'VD': 205.0}, 10: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 10, 'VD': 205.0}, 11: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 11, 'VD': 211.0}, 12: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 12, 'VD': 219.0}, 13: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 13, 'VD': 238.0}, 14: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 14, 'VD': 258.0}, 15: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 15, 'VD': 284.0}, 16: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 16, 'VD': 297.0}, 17: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 17, 'VD': 304.0}, 18: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 18, 'VD': 304.0}, 19: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 19, 'VD': 303.0}, 20: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 20, 'VD': 300.0}, 21: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 21, 'VD': 294.0}, 22: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 22, 'VD': 291.0}, 23: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 23, 'VD': 287.0}, 24: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 24, 'VD': 285.0}, 25: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 25, 'VD': 283.0}, 26: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 26, 'VD': 280.0}, 27: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 27, 'VD': 273.0}, 28: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 28, 'VD': 269.0}, 29: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 29, 'VD': 266.0}, 30: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 30, 'VD': 263.0}, 31: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 31, 'VD': 261.0}, 32: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 32, 'VD': 265.0}, 33: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 33, 'VD': 272.0}, 34: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 34, 'VD': 281.0}, 35: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 35, 'VD': 290.0}, 36: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 36, 'VD': 294.0}, 37: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 37, 'VD': 295.0}, 38: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 38, 'VD': 295.0}, 39: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 39, 'VD': 293.0}, 40: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 40, 'VD': 297.0}, 41: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 41, 'VD': 303.0}, 42: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 42, 'VD': 309.0}, 43: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 43, 'VD': 301.0}, 44: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 44, 'VD': 289.0}, 45: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 45, 'VD': 273.0}, 46: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 46, 'VD': 259.0}, 47: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 47, 'VD': 242.0}, 48: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 48, 'VD': 228.0}, 49: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 1, 'VD': 220.0}, 50: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 2, 'VD': 214.0}, 51: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 3, 'VD': 214.0}, 52: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 4, 'VD': 217.0}, 53: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 5, 'VD': 212.0}, 54: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 6, 'VD': 208.0}, 55: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 7, 'VD': 203.0}, 56: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 8, 'VD': 199.0}, 57: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 9, 'VD': 196.0}, 58: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 10, 'VD': 194.0}}
    ...
    def test_lolp_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 12, 37, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.LOLP',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'LOLP',
                         'TP' : dt.datetime(2017, 4, 21, 0, 12, 31, tzinfo=timezone.utc),
                         'data_points':
                         {1:
                          {'SD' : dt.date(2017, 4, 21),
                           'SP' : 5,
    ...
    def test_ndf_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 16, 29, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.NDF.N',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'NDF',
                         'ZI': 'N',
                         'data_points':
                         {1: {'SD': dt.date(2017, 4, 21), 'SP': 1,
    ...
    def test_df_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2009, 1, 1, 0, 16, 52, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.DF.A',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'DF',
                         'ZI': 'A',
                         'data_points': {
                 1: {'SD': dt.date(2009, 1, 1),
                     'SP': 1,
                     'TP': dt.datetime(2008, 12, 31, 23, 47, tzinfo=timezone.utc),
                     'VD': 6177.0},
                 2: {'SD': dt.date(2009, 1, 1),
                     'SP': 2,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6210.0},
                 3: {'SD': dt.date(2009, 1, 1),
                     'SP': 3,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6305.0},
                 4: {'SD': dt.date(2009, 1, 1),
                     'SP': 4,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6318.0},
                 5: {'SD': dt.date(2009, 1, 1),
                     'SP': 5,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6326.0},
                 6: {'SD': dt.date(2009, 1, 1),
                     'SP': 6,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6234.0},
                 7: {'SD': dt.date(2009, 1, 1),
                     'SP': 7,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 6007.0},
                 8: {'SD': dt.date(2009, 1, 1),
                     'SP': 8,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 5819.0},
                 9: {'SD': dt.date(2009, 1, 1),
                     'SP': 9,
                     'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                     'VD': 5639.0},
                 10: {'SD': dt.date(2009, 1, 1),
                      'SP': 10,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5520.0},
                 11: {'SD': dt.date(2009, 1, 1),
                      'SP': 11,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5448.0},
                 12: {'SD': dt.date(2009, 1, 1),
                      'SP': 12,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5439.0},
                 13: {'SD': dt.date(2009, 1, 1),
                      'SP': 13,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5310.0},
                 14: {'SD': dt.date(2009, 1, 1),
                      'SP': 14,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5304.0},
                 15: {'SD': dt.date(2009, 1, 1),
                      'SP': 15,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5264.0},
                 16: {'SD': dt.date(2009, 1, 1),
                      'SP': 16,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5132.0},
                 17: {'SD': dt.date(2009, 1, 1),
                      'SP': 17,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 4764.0},
                 18: {'SD': dt.date(2009, 1, 1),
                      'SP': 18,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 4878.0},
                 19: {'SD': dt.date(2009, 1, 1),
                      'SP': 19,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 4974.0},
                 20: {'SD': dt.date(2009, 1, 1),
                      'SP': 20,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5072.0},
                 21: {'SD': dt.date(2009, 1, 1),
                      'SP': 21,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5340.0},
                 22: {'SD': dt.date(2009, 1, 1),
                      'SP': 22,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5643.0},
                 23: {'SD': dt.date(2009, 1, 1),
                      'SP': 23,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5930.0},
                 24: {'SD': dt.date(2009, 1, 1),
                      'SP': 24,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6110.0},
                 25: {'SD': dt.date(2009, 1, 1),
                      'SP': 25,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6366.0},
                 26: {'SD': dt.date(2009, 1, 1),
                      'SP': 26,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6360.0},
                 27: {'SD': dt.date(2009, 1, 1),
                      'SP': 27,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6280.0},
                 28: {'SD': dt.date(2009, 1, 1),
                      'SP': 28,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6243.0},
                 29: {'SD': dt.date(2009, 1, 1),
                      'SP': 29,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6251.0},
                 30: {'SD': dt.date(2009, 1, 1),
                      'SP': 30,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6231.0},
                 31: {'SD': dt.date(2009, 1, 1),
                      'SP': 31,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6216.0},
                 32: {'SD': dt.date(2009, 1, 1),
                      'SP': 32,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6388.0},
                 33: {'SD': dt.date(2009, 1, 1),
                      'SP': 33,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6675.0},
                 34: {'SD': dt.date(2009, 1, 1),
                      'SP': 34,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6971.0},
                 35: {'SD': dt.date(2009, 1, 1),
                      'SP': 35,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 7107.0},
                 36: {'SD': dt.date(2009, 1, 1),
                      'SP': 36,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 7126.0},
                 37: {'SD': dt.date(2009, 1, 1),
                      'SP': 37,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 7043.0},
                 38: {'SD': dt.date(2009, 1, 1),
                      'SP': 38,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6909.0},
                 39: {'SD': dt.date(2009, 1, 1),
                      'SP': 39,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6925.0},
                 40: {'SD': dt.date(2009, 1, 1),
                      'SP': 40,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6800.0},
                 41: {'SD': dt.date(2009, 1, 1),
                      'SP': 41,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6685.0},
                 42: {'SD': dt.date(2009, 1, 1),
                      'SP': 42,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6556.0},
                 43: {'SD': dt.date(2009, 1, 1),
                      'SP': 43,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6410.0},
                 44: {'SD': dt.date(2009, 1, 1),
                      'SP': 44,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 6153.0},
                 45: {'SD': dt.date(2009, 1, 1),
                      'SP': 45,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5999.0},
                 46: {'SD': dt.date(2009, 1, 1),
                      'SP': 46,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5765.0},
                 47: {'SD': dt.date(2009, 1, 1),
                      'SP': 47,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5612.0},
                 48: {'SD': dt.date(2009, 1, 1),
                      'SP': 48,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5623.0},
                 49: {'SD': dt.date(2009, 1, 2),
                      'SP': 1,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5767.0},
                 50: {'SD': dt.date(2009, 1, 2),
                      'SP': 2,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5855.0},
                 51: {'SD': dt.date(2009, 1, 2),
                      'SP': 3,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5866.0},
                 52: {'SD': dt.date(2009, 1, 2),
                      'SP': 4,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5678.0},
                 53: {'SD': dt.date(2009, 1, 2),
                      'SP': 5,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5702.0},
                 54: {'SD': dt.date(2009, 1, 2),
                      'SP': 6,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5897.0},
                 55: {'SD': dt.date(2009, 1, 2),
                      'SP': 7,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5916.0},
                 56: {'SD': dt.date(2009, 1, 2),
                      'SP': 8,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5825.0},
                 57: {'SD': dt.date(2009, 1, 2),
                      'SP': 9,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5737.0},
                 58: {'SD': dt.date(2009, 1, 2),
                      'SP': 10,
                      'TP': dt.datetime(2009, 1, 1, 0, 16, tzinfo=timezone.utc),
                      'VD': 5729.0}}
                         }
    ...
    def test_ndfd_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 13, 45, 37, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.NDFD',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'NDFD',
                         'TP': dt.datetime(2017,4,21,13,45, tzinfo=timezone.utc),
                         'data_points': {
                  1: {'SD': dt.date(2017, 4, 23),
                      'SP': 3,
                      'VD': 30950.0},
                  2: {'SD': dt.date(2017, 4, 24),
                      'SP': 3,
                      'VD': 34400.0},
                  3: {'SD': dt.date(2017, 4, 25),
                      'SP': 3,
                      'VD': 34700.0},
                  4: {'SD': dt.date(2017, 4, 26),
                      'SP': 3,
                      'VD': 35690.0},
                  5: {'SD': dt.date(2017, 4, 27),
                      'SP': 3,
                      'VD': 35700.0},
                  6: {'SD': dt.date(2017, 4, 28),
                      'SP': 3,
                      'VD': 35330.0},
                  7: {'SD': dt.date(2017, 4, 29),
                      'SP': 3,
                      'VD': 30090.0},
                  8: {'SD': dt.date(2017, 4, 30),
                      'SP': 3,
                      'VD': 29400.0},
                  9: {'SD': dt.date(2017, 5, 1),
                      'SP': 3,
                      'VD': 31410.0},
                  10: {'SD': dt.date(2017, 5, 2),
                       'SP': 3,
                       'VD': 33770.0},
                  11: {'SD': dt.date(2017, 5, 3),
                       'SP': 3,
                       'VD': 33500.0},
                  12: {'SD': dt.date(2017, 5, 4),
                       'SP': 3,
                       'VD': 32710.0},
                  13: {'SD': dt.date(2017, 5, 5),
                       'SP': 3,
                       'VD': 32360.0}}}
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_tsdfd_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 13, 45, 53, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.TSDFD',
                         'message_type' : 'SYSTEM',
    ...
    def test_imbalngc_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 17, 42, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.IMBALNGC.B1',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'IMBALNGC',
                         'ZI': 'B1',
                         'data_points': {1: {'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 1, 'VI': 636.0}, 2: {'TP': dt.datetime(2017, 4, 20, 23, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 2, 'VI': 660.0}, 3: {'TP': dt.datetime(2017, 4, 20, 23, 45, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 3, 'VI': 634.0}, 4: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 4, 'VI': 634.0}, 5: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 5, 'VI': 652.0}, 6: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 6, 'VI': 672.0}, 7: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 7, 'VI': 685.0}, 8: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 8, 'VI': 692.0}, 9: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 9, 'VI': 695.0}, 10: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 10, 'VI': 687.0}, 11: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 11, 'VI': 664.0}, 12: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 12, 'VI': 639.0}, 13: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 13, 'VI': 629.0}, 14: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 14, 'VI': 646.0}, 15: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 15, 'VI': 676.0}, 16: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 16, 'VI': 659.0}, 17: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 17, 'VI': 646.0}, 18: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 18, 'VI': 648.0}, 19: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 19, 'VI': 659.0}, 20: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 20, 'VI': 692.0}, 21: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 21, 'VI': 698.0}, 22: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 22, 'VI': 698.0}, 23: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 23, 'VI': 680.0}, 24: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 24, 'VI': 704.0}, 25: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 25, 'VI': 689.0}, 26: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 26, 'VI': 719.0}, 27: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 27, 'VI': 742.0}, 28: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 28, 'VI': 758.0}, 29: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 29, 'VI': 758.0}, 30: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 30, 'VI': 764.0}, 31: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 31, 'VI': 790.0}, 32: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 32, 'VI': 795.0}, 33: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 33, 'VI': 809.0}, 34: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 34, 'VI': 819.0}, 35: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 35, 'VI': 805.0}, 36: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 36, 'VI': 778.0}, 37: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 37, 'VI': 749.0}, 38: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 38, 'VI': 715.0}, 39: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 39, 'VI': 678.0}, 40: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 40, 'VI': 627.0}, 41: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 41, 'VI': 562.0}, 42: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 42, 'VI': 499.0}, 43: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 43, 'VI': 467.0}, 44: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 44, 'VI': 436.0}, 45: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 45, 'VI': 345.0}, 46: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 46, 'VI': 321.0}, 47: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 47, 'VI': 315.0}, 48: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 21), 'SP': 48, 'VI': 313.0}, 49: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 1, 'VI': 304.0}, 50: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 2, 'VI': 299.0}, 51: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 3, 'VI': 288.0}, 52: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 4, 'VI': 267.0}, 53: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 5, 'VI': 265.0}, 54: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 6, 'VI': 260.0}, 55: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 7, 'VI': 254.0}, 56: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 8, 'VI': 251.0}, 57: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 9, 'VI': 248.0}, 58: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc), 'SD': dt.date(2017, 4, 22), 'SP': 10, 'VI': 240.0}}
                        }
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_indgen_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 17, 42, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.INDGEN.B14',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'INDGEN',
                         'ZI': 'B14',
                         'data_points': {
                              1: {'SD': dt.date(2017, 4, 21),
                                  'SP': 1,
                                  'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              2: {'SD': dt.date(2017, 4, 21),
                                  'SP': 2,
                                  'TP': dt.datetime(2017, 4, 20, 23, 15, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              3: {'SD': dt.date(2017, 4, 21),
                                  'SP': 3,
                                  'TP': dt.datetime(2017, 4, 20, 23, 45, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              4: {'SD': dt.date(2017, 4, 21),
                                  'SP': 4,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 353.0},
                              5: {'SD': dt.date(2017, 4, 21),
                                  'SP': 5,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 375.0},
                              6: {'SD': dt.date(2017, 4, 21),
                                  'SP': 6,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 357.0},
                              7: {'SD': dt.date(2017, 4, 21),
                                  'SP': 7,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              8: {'SD': dt.date(2017, 4, 21),
                                  'SP': 8,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              9: {'SD': dt.date(2017, 4, 21),
                                  'SP': 9,
                                  'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                  'VG': 255.0},
                              10: {'SD': dt.date(2017, 4, 21),
                                   'SP': 10,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 255.0},
                              11: {'SD': dt.date(2017, 4, 21),
                                   'SP': 11,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 390.0},
                              12: {'SD': dt.date(2017, 4, 21),
                                   'SP': 12,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              13: {'SD': dt.date(2017, 4, 21),
                                   'SP': 13,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              14: {'SD': dt.date(2017, 4, 21),
                                   'SP': 14,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              15: {'SD': dt.date(2017, 4, 21),
                                   'SP': 15,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 430.0},
                              16: {'SD': dt.date(2017, 4, 21),
                                   'SP': 16,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              17: {'SD': dt.date(2017, 4, 21),
                                   'SP': 17,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              18: {'SD': dt.date(2017, 4, 21),
                                   'SP': 18,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              19: {'SD': dt.date(2017, 4, 21),
                                   'SP': 19,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              20: {'SD': dt.date(2017, 4, 21),
                                   'SP': 20,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              21: {'SD': dt.date(2017, 4, 21),
                                   'SP': 21,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              22: {'SD': dt.date(2017, 4, 21),
                                   'SP': 22,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              23: {'SD': dt.date(2017, 4, 21),
                                   'SP': 23,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 431.0},
                              24: {'SD': dt.date(2017, 4, 21),
                                   'SP': 24,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 432.0},
                              25: {'SD': dt.date(2017, 4, 21),
                                   'SP': 25,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 434.0},
                              26: {'SD': dt.date(2017, 4, 21),
                                   'SP': 26,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 435.0},
                              27: {'SD': dt.date(2017, 4, 21),
                                   'SP': 27,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 435.0},
                              28: {'SD': dt.date(2017, 4, 21),
                                   'SP': 28,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 435.0},
                              29: {'SD': dt.date(2017, 4, 21),
                                   'SP': 29,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 434.0},
                              30: {'SD': dt.date(2017, 4, 21),
                                   'SP': 30,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 432.0},
                              31: {'SD': dt.date(2017, 4, 21),
                                   'SP': 31,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 430.0},
                              32: {'SD': dt.date(2017, 4, 21),
                                   'SP': 32,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              33: {'SD': dt.date(2017, 4, 21),
                                   'SP': 33,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              34: {'SD': dt.date(2017, 4, 21),
                                   'SP': 34,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              35: {'SD': dt.date(2017, 4, 21),
                                   'SP': 35,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              36: {'SD': dt.date(2017, 4, 21),
                                   'SP': 36,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 429.0},
                              37: {'SD': dt.date(2017, 4, 21),
                                   'SP': 37,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 430.0},
                              38: {'SD': dt.date(2017, 4, 21),
                                   'SP': 38,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              39: {'SD': dt.date(2017, 4, 21),
                                   'SP': 39,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              40: {'SD': dt.date(2017, 4, 21),
                                   'SP': 40,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 426.0},
                              41: {'SD': dt.date(2017, 4, 21),
                                   'SP': 41,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 426.0},
                              42: {'SD': dt.date(2017, 4, 21),
                                   'SP': 42,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              43: {'SD': dt.date(2017, 4, 21),
                                   'SP': 43,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              44: {'SD': dt.date(2017, 4, 21),
                                   'SP': 44,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              45: {'SD': dt.date(2017, 4, 21),
                                   'SP': 45,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              46: {'SD': dt.date(2017, 4, 21),
                                   'SP': 46,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              47: {'SD': dt.date(2017, 4, 21),
                                   'SP': 47,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              48: {'SD': dt.date(2017, 4, 21),
                                   'SP': 48,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              49: {'SD': dt.date(2017, 4, 22),
                                   'SP': 1,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 427.0},
                              50: {'SD': dt.date(2017, 4, 22),
                                   'SP': 2,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              51: {'SD': dt.date(2017, 4, 22),
                                   'SP': 3,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              52: {'SD': dt.date(2017, 4, 22),
                                   'SP': 4,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              53: {'SD': dt.date(2017, 4, 22),
                                   'SP': 5,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              54: {'SD': dt.date(2017, 4, 22),
                                   'SP': 6,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              55: {'SD': dt.date(2017, 4, 22),
                                   'SP': 7,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              56: {'SD': dt.date(2017, 4, 22),
                                   'SP': 8,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              57: {'SD': dt.date(2017, 4, 22),
                                   'SP': 9,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0},
                              58: {'SD': dt.date(2017, 4, 22),
                                   'SP': 10,
                                   'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                   'VG': 428.0}
                                    }}
    ...
    def test_melngc_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 19, 12, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.MELNGC.B1',
                         'message_type' : 'SYSTEM',
    ...
    def test_inddem_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 0, 20, 44, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.INDDEM.B1',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'INDDEM',
                         'ZI': 'B1',
                         'data_points': {1: {'SD': dt.date(2017, 4, 21),
                     'SP': 1,
                     'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc),
                     'VD': -99.0},
                 2: {'SD': dt.date(2017, 4, 21),
    ...
    def test_windfor_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 4, 31, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.WINDFOR',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'WINDFOR',
                         'data_points': {
                 1: {'SD': dt.date(2017, 4, 21),
                     'SP': 1,
                     'TP': dt.datetime(2017, 4, 20, 22, 30, tzinfo=timezone.utc),
                     'TR': 9910,
                     'VG': 2781.0},
                 2: {'SD': dt.date(2017, 4, 21),
                     'SP': 3,
                 ...
                 22: {'SD': dt.date(2017, 4, 21),
                      'SP': 43,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2773.0},
                 23: {'SD': dt.date(2017, 4, 21),
                      'SP': 45,
                 ...
                 24: {'SD': dt.date(2017, 4, 21),
                      ...
                      'TR': 9910,
                      'VG': 2368.0},
                 25: {'SD': dt.date(2017, 4, 22),
                      'SP': 1,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2296.0},
                 26: {'SD': dt.date(2017, 4, 22),
                      'SP': 3,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2204.0},
                 27: {'SD': dt.date(2017, 4, 22),
                      'SP': 5,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2149.0},
                 28: {'SD': dt.date(2017, 4, 22),
                      'SP': 7,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2108.0},
                 29: {'SD': dt.date(2017, 4, 22),
                      'SP': 9,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2012.0},
                 30: {'SD': dt.date(2017, 4, 22),
                      'SP': 11,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1868.0},
                 31: {'SD': dt.date(2017, 4, 22),
                      'SP': 13,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1708.0},
                 32: {'SD': dt.date(2017, 4, 22),
                      'SP': 15,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1534.0},
                 33: {'SD': dt.date(2017, 4, 22),
                      'SP': 17,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1426.0},
                 34: {'SD': dt.date(2017, 4, 22),
                      'SP': 19,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1412.0},
                 35: {'SD': dt.date(2017, 4, 22),
                      'SP': 21,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1404.0},
                 36: {'SD': dt.date(2017, 4, 22),
                      'SP': 23,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1495.0},
                 37: {'SD': dt.date(2017, 4, 22),
                      'SP': 25,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1554.0},
                 38: {'SD': dt.date(2017, 4, 22),
                      'SP': 27,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1615.0},
                 39: {'SD': dt.date(2017, 4, 22),
                      'SP': 29,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1765.0},
                 40: {'SD': dt.date(2017, 4, 22),
                      'SP': 31,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1895.0},
                 41: {'SD': dt.date(2017, 4, 22),
                      'SP': 33,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2001.0},
                 42: {'SD': dt.date(2017, 4, 22),
                      'SP': 35,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2104.0},
                 43: {'SD': dt.date(2017, 4, 22),
                      'SP': 37,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2044.0},
                 44: {'SD': dt.date(2017, 4, 22),
                      'SP': 39,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2004.0},
                 45: {'SD': dt.date(2017, 4, 22),
                      'SP': 41,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1707.0},
                 46: {'SD': dt.date(2017, 4, 22),
                      'SP': 43,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1466.0},
                 47: {'SD': dt.date(2017, 4, 22),
                      'SP': 45,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1272.0},
                 48: {'SD': dt.date(2017, 4, 22),
                      'SP': 47,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1060.0},
                 49: {'SD': dt.date(2017, 4, 23),
                      'SP': 1,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 902.0},
                 50: {'SD': dt.date(2017, 4, 23),
                      'SP': 3,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 779.0},
                 51: {'SD': dt.date(2017, 4, 23),
                      'SP': 5,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 756.0},
                 52: {'SD': dt.date(2017, 4, 23),
                      'SP': 7,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 745.0},
                 53: {'SD': dt.date(2017, 4, 23),
                      'SP': 9,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 748.0},
                 54: {'SD': dt.date(2017, 4, 23),
                      'SP': 11,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 777.0},
                 55: {'SD': dt.date(2017, 4, 23),
                      'SP': 13,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 808.0},
                 56: {'SD': dt.date(2017, 4, 23),
                      'SP': 15,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 840.0},
                 57: {'SD': dt.date(2017, 4, 23),
                      'SP': 17,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 903.0},
                 58: {'SD': dt.date(2017, 4, 23),
                      'SP': 19,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 984.0},
                 59: {'SD': dt.date(2017, 4, 23),
                      'SP': 21,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1107.0},
                 60: {'SD': dt.date(2017, 4, 23),
                      'SP': 23,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1252.0},
                 61: {'SD': dt.date(2017, 4, 23),
                      'SP': 25,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1431.0},
                 62: {'SD': dt.date(2017, 4, 23),
                      'SP': 27,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1640.0},
                 63: {'SD': dt.date(2017, 4, 23),
                      'SP': 29,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 1861.0},
                 64: {'SD': dt.date(2017, 4, 23),
                      'SP': 31,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2097.0},
                 65: {'SD': dt.date(2017, 4, 23),
                      'SP': 33,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2343.0},
                 66: {'SD': dt.date(2017, 4, 23),
                      'SP': 35,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2466.0},
                 67: {'SD': dt.date(2017, 4, 23),
                      'SP': 37,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2597.0},
                 68: {'SD': dt.date(2017, 4, 23),
                      'SP': 39,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2740.0},
                 69: {'SD': dt.date(2017, 4, 23),
                      'SP': 41,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 2896.0},
                 70: {'SD': dt.date(2017, 4, 23),
                      'SP': 43,
                      'TP': dt.datetime(2017, 4, 21, 4, 30, tzinfo=timezone.utc),
                      'TR': 9910,
                      'VG': 3087.0}
    ...
    def test_ocnmfd_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 12, 38, 37, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.OCNMFD',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'OCNMFD',
                         'TP' : dt.datetime(2017, 4, 21, 12, 37, tzinfo=timezone.utc),
                         'data_points': {
                 1: {'SD': dt.date(2017, 4, 23),
                     'SP': 3,
                     'VM': 10910.0},
    ...
    def test_ocnmfd2_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 12, 39, 24, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.OCNMFD2',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'OCNMFD2',
                         'TP' : dt.datetime(2017, 4, 21, 12, 38, tzinfo=timezone.utc),
                         'data_points': {
                  1: {'DM': 15686.0, 'SD': dt.date(2017, 4, 23)},
                  2: {'DM': 16196.0, 'SD': dt.date(2017, 4, 24)},
                  3: {'DM': 15291.0, 'SD': dt.date(2017, 4, 25)},
                  4: {'DM': 11728.0, 'SD': dt.date(2017, 4, 26)},
                  5: {'DM': 11324.0, 'SD': dt.date(2017, 4, 27)},
                  6: {'DM': 11028.0, 'SD': dt.date(2017, 4, 28)},
                  7: {'DM': 14965.0, 'SD': dt.date(2017, 4, 29)},
                  8: {'DM': 15967.0, 'SD': dt.date(2017, 4, 30)},
                  9: {'DM': 16103.0, 'SD': dt.date(2017, 5, 1)},
                  10: {'DM': 13971.0, 'SD': dt.date(2017, 5, 2)},
                  11: {'DM': 14473.0, 'SD': dt.date(2017, 5, 3)},
                  12: {'DM': 15075.0, 'SD': dt.date(2017, 5, 4)},
                  13: {'DM': 15873.0, 'SD': dt.date(2017, 5, 5)}
                         }}
        self.assertEqual(message_to_dict(input_str), expected_dict)
    ...
    def test_fou2t14d_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 12, 39, 9, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.FOU2T14D',
                         'message_type' : 'SYSTEM',
    ...
    def test_uou2t14d_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 12, 40, 35, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.2__PPGEN001.UOU2T14D',
                         'message_type' : 'SYSTEM',
    ...
    def test_uou2t52w_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 4, 13, 41, 23, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.2__PPGEN001.UOU2T52W',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'UOU2T52W',
                         'bmu_id' : '2__PPGEN001',
                         'TP' : dt.datetime(2018, 1, 4, 13, 31, tzinfo=timezone.utc),
                         'data_points': {
    ...
    def test_syswarn_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 14, 28, 15, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.SYSWARN',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'SYSWARN',
                         'TP' : dt.datetime(2017, 4, 21, 14, 28, 9, tzinfo=timezone.utc),
...
Note	This warning may supersede an NGC System Warning of High Risk of Demand Reduction and will remain in force for the specified period until updated or cancelled by NGC
        ...
        expected_dict = {'received_time' : dt.datetime(2002, 1, 8, 1, 42, 9, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.SYSWARN',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'SYSWARN',
                         'TP' : dt.datetime(2002, 1, 8, 1, 42, 9, tzinfo=timezone.utc),
...
Note	This warning may supersede an NGC System Warning of High Risk of Demand Reduction and will remain in force for the specified period until updated or cancelled by NGC'''
    ...
    def test_sysmsg_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 2, 17, 52, 56, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.SYSMSG',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'SYSMSG',
                         'TP' : dt.datetime(2018, 1, 2, 17, 51, 46, tzinfo=timezone.utc),
                         'MT' : 'MIDNP',
    ...
    def test_temp_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 15, 45, 35, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.TEMP',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'TEMP',
                         'TP' : dt.datetime(2017, 4, 21, 15, 45, tzinfo=timezone.utc),
                         'TS' : dt.datetime(2017, 4, 21, 11, tzinfo=timezone.utc),
                         'TO' : 11.2,
                         'TN' : 9.9,
                         'TL' : 7.0,
                         'TH' : 12.5}
    ...
    def test_cdn_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 23, 13, 54, tzinfo=timezone.utc),
                         'subject' : 'BMRA.BP.GALENA.CDN',
                         'message_type' : 'BP',
                         'message_subtype' : 'CDN',
                         'bmu_id' : 'GALENA',
                         'DL' : 2,
                         'ED' : dt.date(2017, 4, 22),
                         'EP' : 3}
    ...
    def test_indod_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 21, 23, 15, 37, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.INDOD',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'INDOD',
                         'TP' : dt.datetime(2017, 4, 21, 23, 15, tzinfo=timezone.utc),
                         'SD' : dt.date(2017, 4, 21),
                         'EO' : 716234,
                         'EL' : 657654,
                         'EH' : 808531,
    ...
    def test_TSDFW_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 27, 13, 45, 44, tzinfo=timezone.utc),
                 ...
                 1: {'VD': 33970.0,
                     ...
                     'WN': 19},
                 2: {'VD': 33040.0,
                     'WD': dt.date(2017, 5, 15),
                     'WN': 20},
                 3: {'VD': 32410.0,
                     'WD': dt.date(2017, 5, 22),
                     'WN': 21},
                 4: {'VD': 32010.0,
                     'WD': dt.date(2017, 5, 29),
                     'WN': 22},
                 5: {'VD': 31950.0,
                     'WD': dt.date(2017, 6, 5),
                     'WN': 23},
                 6: {'VD': 31660.0,
                     'WD': dt.date(2017, 6, 12),
                     'WN': 24},
                 7: {'VD': 31240.0,
                     'WD': dt.date(2017, 6, 19),
                     'WN': 25},
                 8: {'VD': 31160.0,
                     'WD': dt.date(2017, 6, 26),
                     'WN': 26},
                 9: {'VD': 31140.0,
                     'WD': dt.date(2017, 7, 3),
                     'WN': 27},
                 10: {'VD': 31030.0,
                      'WD': dt.date(2017, 7, 10),
                      'WN': 28},
                 11: {'VD': 32030.0,
                      'WD': dt.date(2017, 7, 17),
                      'WN': 29},
                 12: {'VD': 31508.0,
                      'WD': dt.date(2017, 7, 24),
                      'WN': 30},
                 13: {'VD': 31696.0,
                      'WD': dt.date(2017, 7, 31),
                      'WN': 31},
                 14: {'VD': 32410.0,
                      'WD': dt.date(2017, 8, 7),
                      'WN': 32},
                 15: {'VD': 33260.0,
                      'WD': dt.date(2017, 8, 14),
                      'WN': 33},
                 16: {'VD': 33978.0,
                      'WD': dt.date(2017, 8, 21),
                      'WN': 34},
                 17: {'VD': 34904.0,
                      'WD': dt.date(2017, 8, 28),
                      'WN': 35},
                 18: {'VD': 36027.0,
                      'WD': dt.date(2017, 9, 4),
                      'WN': 36},
                 19: {'VD': 36613.0,
                      'WD': dt.date(2017, 9, 11),
                      'WN': 37},
                 20: {'VD': 37876.0,
                      'WD': dt.date(2017, 9, 18),
                      'WN': 38},
                 21: {'VD': 38874.0,
                      'WD': dt.date(2017, 9, 25),
                      'WN': 39},
                 22: {'VD': 39947.0,
                      'WD': dt.date(2017, 10, 2),
                      'WN': 40},
                 23: {'VD': 41029.0,
                      'WD': dt.date(2017, 10, 9),
                      'WN': 41},
                 24: {'VD': 42368.0,
                      'WD': dt.date(2017, 10, 16),
                      'WN': 42},
                 25: {'VD': 42847.0,
                      'WD': dt.date(2017, 10, 23),
                      'WN': 43},
                 26: {'VD': 45510.0,
                      'WD': dt.date(2017, 10, 30),
                      'WN': 44},
                 27: {'VD': 46671.0,
                      'WD': dt.date(2017, 11, 6),
                      'WN': 45},
                 28: {'VD': 47267.0,
                      'WD': dt.date(2017, 11, 13),
                      'WN': 46},
                 29: {'VD': 48044.0,
                      'WD': dt.date(2017, 11, 20),
                      'WN': 47},
                 30: {'VD': 48265.0,
                      'WD': dt.date(2017, 11, 27),
                      'WN': 48},
                 31: {'VD': 49303.0,
                      'WD': dt.date(2017, 12, 4),
                      'WN': 49},
                 32: {'VD': 49889.0,
                      'WD': dt.date(2017, 12, 11),
                      'WN': 50},
                 33: {'VD': 49428.0,
                      'WD': dt.date(2017, 12, 18),
                      'WN': 51},
                 34: {'VD': 44450.0,
                      'WD': dt.date(2017, 12, 25),
                      'WN': 52},
                 35: {'VD': 48753.0,
                      'WD': dt.date(2018, 1, 1),
                      'WN': 1},
                 36: {'VD': 49280.0,
                      ...
                      'WN': 2},
                 37: {'VD': 48915.0,
                      'WD': dt.date(2018, 1, 15),
                      'WN': 3},
                 38: {'VD': 49060.0,
                      'WD': dt.date(2018, 1, 22),
                      'WN': 4},
                 39: {'VD': 48683.0,
                      'WD': dt.date(2018, 1, 29),
                      'WN': 5},
                 40: {'VD': 48139.0,
                      'WD': dt.date(2018, 2, 5),
                      'WN': 6},
                 41: {'VD': 47201.0,
                      'WD': dt.date(2018, 2, 12),
                      'WN': 7},
                 42: {'VD': 46668.0,
                      'WD': dt.date(2018, 2, 19),
                      'WN': 8},
                 43: {'VD': 45996.0,
                      'WD': dt.date(2018, 2, 26),
                      'WN': 9},
                 44: {'VD': 45172.0,
                      'WD': dt.date(2018, 3, 5),
                      'WN': 10},
                 45: {'VD': 44460.0,
                      'WD': dt.date(2018, 3, 12),
                      'WN': 11},
                 46: {'VD': 42797.0,
                      'WD': dt.date(2018, 3, 19),
                      'WN': 12},
                 47: {'VD': 40651.0,
                      'WD': dt.date(2018, 3, 26),
                      'WN': 13},
                 48: {'VD': 39598.0,
                      'WD': dt.date(2018, 4, 2),
                      'WN': 14},
                 49: {'VD': 38254.0,
                      ...
                      'WN': 15},
                 50: {'VD': 37149.0,
                      'WD': dt.date(2018, 4, 16),
                      'WN': 16},
                 51: {'VD': 36207.0,
                      'WD': dt.date(2018, 4, 23),
                      'WN': 17}}
                         }
    ...
    def test_NDFW_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2017, 4, 27, 13, 46, 0, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.NDFW',
                         'message_type' : 'SYSTEM',
    ...
    def test_OCNMFW_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 4, 13, 35, 52, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.OCNMFW',
                         'message_type' : 'SYSTEM',
                 ...
                 15: {'VM': 13588.0,
                      ...
                      'WN': 17},
                 16: {'VM': 13438.0,
                      'WD': dt.date(2018, 4, 30),
                      'WN': 18},
                 17: {'VM': 12305.0,
                      'WD': dt.date(2018, 5, 7),
                      'WN': 19},
                 18: {'VM': 14366.0,
                      'WD': dt.date(2018, 5, 14),
                      'WN': 20},
                 19: {'VM': 14562.0,
                      'WD': dt.date(2018, 5, 21),
                      'WN': 21},
                 20: {'VM': 17926.0,
                      'WD': dt.date(2018, 5, 28),
                      'WN': 22},
                 21: {'VM': 13759.0,
                      'WD': dt.date(2018, 6, 4),
                      'WN': 23},
                 22: {'VM': 13488.0,
                      'WD': dt.date(2018, 6, 11),
                      'WN': 24},
                 23: {'VM': 13715.0,
                      'WD': dt.date(2018, 6, 18),
                      'WN': 25},
                 24: {'VM': 12919.0,
                      'WD': dt.date(2018, 6, 25),
                      'WN': 26},
                 25: {'VM': 11096.0,
                      'WD': dt.date(2018, 7, 2),
                      'WN': 27},
                 26: {'VM': 9618.0,
                      ...
                      'WN': 28},
                 27: {'VM': 12856.0,
                      'WD': dt.date(2018, 7, 16),
                      'WN': 29},
                 28: {'VM': 14795.0,
                      'WD': dt.date(2018, 7, 23),
                      'WN': 30},
                 29: {'VM': 15440.0,
                      'WD': dt.date(2018, 7, 30),
                      'WN': 31},
                 30: {'VM': 15990.0,
                      'WD': dt.date(2018, 8, 6),
                      'WN': 32},
                 31: {'VM': 15907.0,
                      'WD': dt.date(2018, 8, 13),
                      'WN': 33},
                 32: {'VM': 15868.0,
                      'WD': dt.date(2018, 8, 20),
                      'WN': 34},
                 33: {'VM': 16813.0,
                      'WD': dt.date(2018, 8, 27),
                      'WN': 35},
                 34: {'VM': 15632.0,
                      'WD': dt.date(2018, 9, 3),
                      'WN': 36},
                 35: {'VM': 12593.0,
                      'WD': dt.date(2018, 9, 10),
                      'WN': 37},
                 36: {'VM': 12833.0,
                      'WD': dt.date(2018, 9, 17),
                      'WN': 38},
                 37: {'VM': 13727.0,
                      'WD': dt.date(2018, 9, 24),
                      'WN': 39},
                 38: {'VM': 12985.0,
                      'WD': dt.date(2018, 10, 1),
                      'WN': 40},
                 39: {'VM': 11670.0,
                      'WD': dt.date(2018, 10, 8),
                      'WN': 41},
                 40: {'VM': 10954.0,
                      'WD': dt.date(2018, 10, 15),
                      'WN': 42},
                 41: {'VM': 10741.0,
                      'WD': dt.date(2018, 10, 22),
                      'WN': 43},
                 42: {'VM': 9306.0,
                      'WD': dt.date(2018, 10, 29),
                      'WN': 44},
                 43: {'VM': 8613.0,
                      'WD': dt.date(2018, 11, 5),
                      'WN': 45},
                 44: {'VM': 8440.0,
                      'WD': dt.date(2018, 11, 12),
                      'WN': 46},
                 45: {'VM': 7211.0,
                      'WD': dt.date(2018, 11, 19),
                      'WN': 47},
                 46: {'VM': 7408.0,
                      'WD': dt.date(2018, 11, 26),
                      'WN': 48},
                 47: {'VM': 6461.0,
                      'WD': dt.date(2018, 12, 3),
                      'WN': 49},
                 48: {'VM': 6399.0,
                      'WD': dt.date(2018, 12, 10),
                      'WN': 50},
                 49: {'VM': 5329.0,
                      'WD': dt.date(2018, 12, 17),
                      'WN': 51},
                 50: {'VM': 11976.0,
                      'WD': dt.date(2018, 12, 24),
                      'WN': 52},
                 51: {'VM': 7743.0,
                      'WD': dt.date(2018, 12, 31),
                      'WN': 1}}
                         }
    ...
    def test_OCNMFW2_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 4, 13, 37, 17, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.OCNMFW2',
                         'message_type' : 'SYSTEM',
                         'message_subtype' : 'OCNMFW2',
                         'TP' : dt.datetime(2018, 1, 4, 13, 35, tzinfo=timezone.utc),
                         'data_points' : {
    ...
    def test_fou2t52w_to_dict(self):
        ...
        expected_dict = {'received_time' : dt.datetime(2018, 1, 4, 13, 37, 11, tzinfo=timezone.utc),
                         'subject' : 'BMRA.SYSTEM.FOU2T52W',
                         'message_type' : 'SYSTEM',
