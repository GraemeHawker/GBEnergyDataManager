...
class DataProcessingTestCase(unittest.TestCase):
    ...
    def test_tsdf_to_dict(self):
        ...
        expected_dict = {'received_time': dt.datetime(2017, 4, 21, 0, 16, 40, tzinfo=timezone.utc),
                         ...
                         'ZI': 'B1',
                         'data_points': {1: {'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 1, 'VD': 218.0},
                                         2: {'TP': dt.datetime(2017, 4, 20, 23, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 2, 'VD': 211.0},
                                         3: {'TP': dt.datetime(2017, 4, 20, 23, 45, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 3, 'VD': 217.0},
                                         4: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 4, 'VD': 217.0},
                                         5: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 5, 'VD': 215.0},
                                         6: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 6, 'VD': 212.0},
                                         7: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 7, 'VD': 209.0},
                                         8: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 8, 'VD': 207.0},
                                         9: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 9, 'VD': 205.0},
                                         10: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 10, 'VD': 205.0},
                                         11: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 11, 'VD': 211.0},
                                         12: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 12, 'VD': 219.0},
                                         13: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 13, 'VD': 238.0},
                                         14: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 14, 'VD': 258.0},
                                         15: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 15, 'VD': 284.0},
                                         16: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 16, 'VD': 297.0},
                                         17: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 17, 'VD': 304.0},
                                         18: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 18, 'VD': 304.0},
                                         19: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 19, 'VD': 303.0},
                                         20: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 20, 'VD': 300.0},
                                         21: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 21, 'VD': 294.0},
                                         22: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 22, 'VD': 291.0},
                                         23: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 23, 'VD': 287.0},
                                         24: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 24, 'VD': 285.0},
                                         25: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 25, 'VD': 283.0},
                                         26: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 26, 'VD': 280.0},
                                         27: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 27, 'VD': 273.0},
                                         28: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 28, 'VD': 269.0},
                                         29: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 29, 'VD': 266.0},
                                         30: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 30, 'VD': 263.0},
                                         31: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 31, 'VD': 261.0},
                                         32: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 32, 'VD': 265.0},
                                         33: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 33, 'VD': 272.0},
                                         34: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 34, 'VD': 281.0},
                                         35: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 35, 'VD': 290.0},
                                         36: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 36, 'VD': 294.0},
                                         37: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 37, 'VD': 295.0},
                                         38: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 38, 'VD': 295.0},
                                         39: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 39, 'VD': 293.0},
                                         40: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 40, 'VD': 297.0},
                                         41: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 41, 'VD': 303.0},
                                         42: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 42, 'VD': 309.0},
                                         43: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 43, 'VD': 301.0},
                                         44: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 44, 'VD': 289.0},
                                         45: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 45, 'VD': 273.0},
                                         46: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 46, 'VD': 259.0},
                                         47: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 47, 'VD': 242.0},
                                         48: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 48, 'VD': 228.0},
                                         49: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 1, 'VD': 220.0},
                                         50: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 2, 'VD': 214.0},
                                         51: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 3, 'VD': 214.0},
                                         52: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 4, 'VD': 217.0},
                                         53: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 5, 'VD': 212.0},
                                         54: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 6, 'VD': 208.0},
                                         55: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 7, 'VD': 203.0},
                                         56: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 8, 'VD': 199.0},
                                         57: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 9, 'VD': 196.0},
                                         58: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 10, 'VD': 194.0}}
    ...
    def test_imbalngc_to_dict(self):
        ...
        expected_dict = {'received_time': dt.datetime(2017, 4, 21, 0, 17, 42, tzinfo=timezone.utc),
                         ...
                         'ZI': 'B1',
                         'data_points': {1: {'TP': dt.datetime(2017, 4, 20, 22, 45, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 1, 'VI': 636.0},
                                         2: {'TP': dt.datetime(2017, 4, 20, 23, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 2, 'VI': 660.0},
                                         3: {'TP': dt.datetime(2017, 4, 20, 23, 45, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 3, 'VI': 634.0},
                                         4: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 4, 'VI': 634.0},
                                         5: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 5, 'VI': 652.0},
                                         6: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 6, 'VI': 672.0},
                                         7: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 7, 'VI': 685.0},
                                         8: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 8, 'VI': 692.0},
                                         9: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                             'SD': dt.date(2017, 4, 21), 'SP': 9, 'VI': 695.0},
                                         10: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 10, 'VI': 687.0},
                                         11: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 11, 'VI': 664.0},
                                         12: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 12, 'VI': 639.0},
                                         13: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 13, 'VI': 629.0},
                                         14: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 14, 'VI': 646.0},
                                         15: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 15, 'VI': 676.0},
                                         16: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 16, 'VI': 659.0},
                                         17: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 17, 'VI': 646.0},
                                         18: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 18, 'VI': 648.0},
                                         19: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 19, 'VI': 659.0},
                                         20: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 20, 'VI': 692.0},
                                         21: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 21, 'VI': 698.0},
                                         22: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 22, 'VI': 698.0},
                                         23: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 23, 'VI': 680.0},
                                         24: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 24, 'VI': 704.0},
                                         25: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 25, 'VI': 689.0},
                                         26: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 26, 'VI': 719.0},
                                         27: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 27, 'VI': 742.0},
                                         28: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 28, 'VI': 758.0},
                                         29: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 29, 'VI': 758.0},
                                         30: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 30, 'VI': 764.0},
                                         31: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 31, 'VI': 790.0},
                                         32: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 32, 'VI': 795.0},
                                         33: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 33, 'VI': 809.0},
                                         34: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 34, 'VI': 819.0},
                                         35: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 35, 'VI': 805.0},
                                         36: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 36, 'VI': 778.0},
                                         37: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 37, 'VI': 749.0},
                                         38: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 38, 'VI': 715.0},
                                         39: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 39, 'VI': 678.0},
                                         40: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 40, 'VI': 627.0},
                                         41: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 41, 'VI': 562.0},
                                         42: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 42, 'VI': 499.0},
                                         43: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 43, 'VI': 467.0},
                                         44: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 44, 'VI': 436.0},
                                         45: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 45, 'VI': 345.0},
                                         46: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 46, 'VI': 321.0},
                                         47: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 47, 'VI': 315.0},
                                         48: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 21), 'SP': 48, 'VI': 313.0},
                                         49: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 1, 'VI': 304.0},
                                         50: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 2, 'VI': 299.0},
                                         51: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 3, 'VI': 288.0},
                                         52: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 4, 'VI': 267.0},
                                         53: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 5, 'VI': 265.0},
                                         54: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 6, 'VI': 260.0},
                                         55: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 7, 'VI': 254.0},
                                         56: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 8, 'VI': 251.0},
                                         57: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 9, 'VI': 248.0},
                                         58: {'TP': dt.datetime(2017, 4, 21, 0, 15, tzinfo=timezone.utc),
                                              'SD': dt.date(2017, 4, 22), 'SP': 10, 'VI': 240.0}}
                         }
        self.assertEqual(message_to_dict(input_str), expected_dict)
